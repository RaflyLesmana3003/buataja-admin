        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="display-2 text-white d-inline-block mb-0">Karya gambar 🚀</h6>
            </div>
          </div>
          <!-- Card stats -->
          <div class="row">
      ...
      <div class="row justify-content-center">
            ...
            <div class="card" id='form1'>
              ...
              <span id="message"></span>
                  ...
                  <div class="form-row">
                    ...
                    <textarea class="form-control"  id="caption" rows="2" resize="none" required placeholder="hallo guys...."></textarea>
            ...
            <div class="card  ">
              ...
              <div class="card-body">
                  ...
                  <div class="align-right">  <button class="btn btn-warning ld-ext-right " id="btn1" form="form" type="submit"> buat karya</button>
      ...
      var $dropzonePreview = $('.dz-preview');
       Dropzone.options.dropzone =
        ...
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          ...
          url: "/1add3fc77e463ea813e4b0f2d4028fe7",
