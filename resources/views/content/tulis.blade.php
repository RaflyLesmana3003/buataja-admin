        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="display-2 text-white d-inline-block mb-0">Karya tulis 🚀</h6>
            </div>
          </div>
          <!-- Card stats -->
          <div class="row">
              ...
              <span id="message"></span>
                  ...
                  <div class="form-row">
                    ...
                    <form id="form" name="form">
                      ...
                      <br>
                      <label class="form-control-label" for="customFile">cover</label><br>
                    ...
                    <label class="form-control-label" for="formatter">karya anda</label>
                        <div class="focused" data-toggle="quill" id="desc"  data-quill-placeholder="pada hari minggu itu"></div>
                        <br>

                    <label class="form-control-label" for="validationCustom01">lampiran file</label>
      ...
      var $dropzonePreview = $('.dz-preview');
       Dropzone.options.dropzone =
        ...
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          ...
          url: "/7af8c017995f445a4d7c7d7735e94226",
