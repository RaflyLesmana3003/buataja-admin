        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="display-2 text-white d-inline-block mb-0">Karya video 🚀</h6>
            </div>
          </div>
          <!-- Card stats -->
          <div class="row">
            ...
            <div class="card" id='form1'>
              ...
              <span id="message"></span>
                  ...
                  <div class="form-row">
                    ...
                    <label class="form-control-label" for="validationCustom01">upload karya</label>
                    <label class="form-control-label text-muted" >atau melalui sematan url di deskripsi</label>
      ...
      var $dropzonePreview = $('.dz-preview');
       Dropzone.options.dropzone =
        ...
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          ...
          url: "/421b47ffd946ca083b65cd668c6b17e6",
  ...
  for (var i = 0; i < arrInputs.length; i++) {
   ...
   success:function(data){
          ...
          error: function(file, response)
          {
            ...
            if (file.responseJSON === 'undefined') {
              $("#message").append('<div  class="aa alert alert-'+file.responseJSON.tipe+' alert-block"><button type="button" class="close" data-dismiss="alert">×</button> <strong>'+file.responseJSON.data+'</strong></div>');
            setTimeout("$('.aa').fadeOut(1000);", 3000);
            $("#message").attr("id", "message1");
            $("html, body").animate({ scrollTop: 0 }, "slow");
            }else{
              $("#message").append('<div  class="aa alert alert-danger" alert-block"><button type="button" class="close" data-dismiss="alert">×</button> <strong>file harus diisi dan harus .mp4</strong></div>');
            setTimeout("$('.aa').fadeOut(1000);", 3000);
            $("#message").attr("id", "message1");
            $("html, body").animate({ scrollTop: 0 }, "slow");
            }
